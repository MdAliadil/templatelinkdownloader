<nav class="navbar navbar-expand-lg navbar-light p-0">
                    ...
                    <div class="iq-search-bar">
                        <form action="#" class="searchbox">
                            <input type="text" class="text search-input" placeholder="Search your Temp's...">
                                    ...
                                    <div class="iq-card shadow-none m-0">
                                        <div class="iq-card-body p-0 ">
                                            ...
                                            <a href="#" class="iq-sub-card">
                                                <div class="media align-items-center">
                                                    <div class="">
                                                        <img class="avatar-40 rounded" src="{{asset('images/user/03.jpg') }}"
                                                            alt="">
                                                    </div>
                                                    <div class="media-body ml-3">
                                            ...
                                            <a href="#" class="iq-sub-card">
                                                <div class="media align-items-center">
                                                    <div class="">
                                                        <img class="avatar-40 rounded" src="{{asset('images/user/04.jpg') }}"
                                                            alt="">
                                                    </div>
                                                    <div class="media-body ml-3">
                                    ...
                                    <div class="iq-card shadow-none m-0">
                                        <div class="iq-card-body p-0 ">
                                            ...
                                            <a href="#" class="iq-sub-card">
                                                <div class="media align-items-center">
                                                    <div class="">
                                                        <img class="avatar-40 rounded" src="{{asset('images/user/05.jpg') }}"
                                                            alt="">
                                                    </div>
                                                    <div class="media-body ml-3">
                        ...
                        <li class="line-height">
                            <a href="#" class="search-toggle iq-waves-effect d-flex align-items-center">
                                ...
                                <div class="caption">
                                    ...
                                    <p class="mb-0 text-capitalize">{{ auth()->user()->getRoleNames()->first() }}</p>
                                </div>
                            </a>
    ...
    <form method="POST" action="{{ route('logout') }}">
        @csrf
        <button type="submit" class="bg-primary iq-sign-btn border-0" style="cursor: pointer;">
